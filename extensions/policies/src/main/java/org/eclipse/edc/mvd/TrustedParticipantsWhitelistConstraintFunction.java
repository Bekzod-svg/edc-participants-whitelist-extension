...
/**
 * This class implements the AtomicConstraintFunction interface and is used for
 * evaluating
 * permissions based on a whitelist of trusted participants.
 * It checks if the participants involved in a policy context are present in the
 * trusted
